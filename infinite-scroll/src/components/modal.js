          ...
          <div className={`modal-content`}>
            ...
            <div className={`info-body`}>
              ...
              <div className={`info-about`}>
                ...
                <p className={`warn`}>{`As a note of caution, please be aware that the tweets generated by this app are not reflective of the Twitter user whose tweets were used the generate them. The AI used in this application was trained on many other distinct sources that influence its text generation. This is a school project that was created for educational purposes only.`}</p>
