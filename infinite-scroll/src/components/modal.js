          ...
          <div className={`modal-content`}>
            ...
            <div className={`info-body`}>
              ...
              <div className={`dark-mode-toggle`}>
                <span className={`light-toggle-label`}>{`Toggle light/dark mode:`}</span>
                <span className={`light-toggle`} onClick={() => toggleDarkMode( ! darkMode )} />
              </div>
              <div className={`clear-settings`}>
                <a onClick={toggleDemo}>{`Toggle demo`}</a>
              </div>
              <div className={`clear-settings`}>
                <a onClick={() => clearLocalStorage()}>{`Reset settings and clear cache`}</a>
              </div>
              ...
              <div className={`info-credits`}>
                ...
                <p>{`Check out our GitHub repo `}<a href="https://github.com/jkelaty/infinite-scroll-is-not-enough" target="_blank" noreferrer="true" >{`here!`}</a></p>
              </div>
