        ...
        <div className={`modal-background`}>
          <div className={`modal-content`}>
            ...
            <div className={`intro-body`}>
              <p>{`Contributors: Jonathan, Xuejin, Benjaim, Ka Ming`}</p>
              ...
              <p className={`left`}>{`As a note of caution, please be aware that the tweets generated by this app are not reflective of the Twitter user whose tweets were used the generate them. The AI used in this application was trained on many other distinct sources that influence its text generation.`}</p>
            </div>
